...
public class SpectrumVisual : MonoBehaviour
{
    ...
    {
        old_value = cur_value;
        if(SpectrumData.spectrum_value > spectrum_value_line && old_value < spectrum_value_line)
        {
            //Debug.Log("xxxxxxx");
        }
        ...
        {
            if (cur_value > spectrum_value_line && old_value < spectrum_value_line)
            {
